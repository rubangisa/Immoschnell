      ...
      <div className="addListing-wrapper">
        <div className="add-left-container1">
          ...
          <div className="add-col leftCol3">
            ...
            <input className="addListing-input" type="number" name="number" placeholder="enter number of beds..." required/>
          </div>
            </div>
            <div className="add-leftRow2">
            <label htmlFor="name">Property description*</label> <br />
            <textarea className="add-textarea" name="name" id="" cols="80" rows="20" placeholder="enter Property description..." required></textarea>
            </div>
            ...
            <div className="add-row3">
                <div className="add-iconsRow add-iconsRow1">
                    ...
                    <div>
                    <FaUmbrellaBeach />
                    <p className="icon-name">outdoor <br /> seating</p>
                    </div>
                    <div>
                    <GiFireplace />
                    ...
                    <div>
                    <GiPoolTableCorner />
                    <p className="icon-name">pool <br /> table</p>
                    </div>
                    <div>
                    <GiGrandPiano />
                ...
                <div className="add-iconsRow add-iconsRow2">
                    ...
                    <p className="icon-name">laundry<br />facilities</p>
                    </div>
                    <div>
                    <FaCar />
                    <p className="icon-name">free<br />parking</p>
                    </div>
                    <div>
                    <FaTachometerAlt />
                    <p className="icon-name">metered<br />parking</p>
                    </div>
                    <div>
                    <FaRegSnowflake />
        ...
        <div className="add-rightRow1">
            ...
            />
            <label htmlFor="name">number of bathrooms</label>
            <input className="addListing-input" type="number" name="number" placeholder="enter number of bathrooms..."/>
            <label htmlFor="name">accessibility features*</label>
          ...
          <div className="add-col rightCol2">
            ...
            <input className="addListing-input" type="name" name="name" placeholder="price per night..." required/>
          ...
          <div className="add-col rightCol3">
            ...
            <label htmlFor="name">children allowed*?</label>
            <input className="addListing-input" type="name" name="name" placeholder="select option" required/>
          ...
          <div className="add-col rightCol4">
            ...
            <div className="add-rightRow2 drag-area" onClick={() => document.querySelector(".input-uploadPhoto").click()} >
                <div className="add-uploadPhotosPs" onDragOver={onDragOver} onDragLeave={onDragLeave} onDrop={onDrop} >
                  <form >
                  
                    { isDragging || selectedImages.length > 0 &&
                    (selectedImages.length > 5 ? (
                      <p>You can't upload more than 5 images! <br />
                        <span className="error">please delete <b>{selectedImages.length -5} </b>of them</span>
                       </p>
                    ) : (
                      <p className="upload-btn" onClick={() => {console.log("Uploaded Images")}}><PiHouseSimple className="PiHouseSimpleIcon" color="rgb(6, 68, 38)" /> Uploaded {selectedImages.length} Max {selectedImages.length === 1 ? "" : "(5)"}</p>
                    ))
                  }
                  <input className="input-uploadPhoto" type="file" multiple accept='image/*' hidden
                    ...
                    {/* <input className="input-uploadPhoto" type="file" accept='image/*' hidden
                      ...
                      {image || isDragging ? (
                        <img className="uploaded-img" src={image} alt={fileName}/>
                        
                        ) : (
                          <>
                          <p className="add-uploadPhotoP1">drag your images here,  or browse <FaCloudUploadAlt/></p>
                          </>
                          )
                        }
                      */}
